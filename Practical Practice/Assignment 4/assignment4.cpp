...
int main(){
    ...
    table.insert("Tirthraj Mahajan","8767945245");
    table.insert("Aditya Mulay","9423157239");
    table.insert("Vardhan Dongre","8007183659");
    table.insert("Ninad Palsule","7798886107");
    table.insert("Arnav Vaidya","9764028218");
    table.insert("Kedar Vartak","9325487675");
    table.insert("Amey Kulkarni","8329654110");
    table.insert("Shreyas Nagarkar","9175940454");
    table.insert("Aditya Kulkarni", "8459281749");
    table.viewTable();
    ...
    */
    ...
    table.insert("Harsh B","7559105287");      
    table.insert("Nidhish Kasbekar", "7038086410");
    ...
    table.searchRecord("Vedang Urade");
